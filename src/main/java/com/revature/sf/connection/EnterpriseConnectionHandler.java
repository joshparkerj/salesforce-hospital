...
public enum EnterpriseConnectionHandler {
	...
	private EnterpriseConnectionHandler() {
		...
		contractHelper = new ContractHelper(connection);
	...
	public List<DomainContract> getAllContracts() {
		return contractHelper.getAllContracts();
	}
	...
	public DomainContract getContractById(String id) {
		return contractHelper.domainContractFromContract(
				(Contract) getSObjectById("SELECT Id, Status, StartDate, ContractTerm, AccountId FROM Contract", id));
	}
	...
	public DomainContract saveNewContract(DomainContract a) {
		return contractHelper.saveNewContract(a);
	}
	...
	public DomainContract updateContract(@Valid DomainContract a) {
		return contractHelper.updateContract(a);
	}
